...
import net.kebernet.skillz.ResponseMapper;
...
public class DynamicServlet extends SpeechletServlet {
    ...
    public DynamicServlet(final ResponseMapper responseMapper, final Registry registry, final Object implementation, final IntrospectionData data){
        ...
        this.setSpeechlet(new DynamicSpeechlet(methods, data, responseMapper, registry, implementation));
            ...
            .map(param ->{
                ...
                if(slotAnnotation != null){
                    try {
                        ...
                        return new ParameterValue(param.getName(), coersion.coerce(slot.getValue(), param.getType()));
    ...
    static class DynamicSpeechlet implements Speechlet {
        ...
        public DynamicSpeechlet(ArrayListMultimap<String, InvokableMethod> methods, IntrospectionData data, ResponseMapper responseMapper, Registry registry, Object implementation) {
